...
module.exports = class initialSchema1747936348108 {
  name = 'initialSchema1747936348108';
  ...
  async down(queryRunner) {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "admin" boolean NOT NULL DEFAULT (1), "extra" varchar)`,
    );
    await queryRunner.query(
