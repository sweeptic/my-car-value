...
module.exports = class initialSchema1747936165254 {
  name = 'initialSchema1747936165254';
  ...
  async down(queryRunner) {
    ...
    await queryRunner.query(
      `CREATE TABLE "user" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar NOT NULL, "password" varchar NOT NULL, "admin" boolean NOT NULL DEFAULT (1), "extra" )`,
    );
    await queryRunner.query(
